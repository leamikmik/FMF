...
n-ti koren st $z=r(\cos(\phi)+i\sin(\phi))$ so ogljisca pravilnega n-kotnika vcrtanega krogu z radijem $\sqrt[n]{r}$. Eno od ogl. n-kotnika je tocka $(\sqrt[n]{r}*\cos(\frac{\phi}{n}),\sqrt[n]{r}*\sin(\frac{\phi}{n}))$

...
iscemo korene kompleksnih stevil $z=a+ib$
$w=x+iy$
$w=^n\sqrt{z}$
$w^{n}=z$
$z=r(\cos(\psi) +i\sin(\psi))$
iscemo 
$w=s(\cos(\phi)+i\sin(\phi))$ %% Zameni phi z psi %%
$s=^n\sqrt{r}$
$\psi=\frac{\phi}{n}$
$\psi_{k}=\frac{\phi}{n}+k\frac{2\pi}{n}$
Naj bo $w_{k}=s(\cos(\psi) +i\sin(\psi))$
velja $w_{k}^{n}=z\ z_{r}\lor k=0,1,...,n-1$
$w_{n}=^n\sqrt{s}(\cos(\phi/n)+i\sin(\phi/n))=w_{0}$
$w_{n+k}=w_{k}=^{n}\sqrt{s}(\cos(\psi_{k})+i\sin(\psi_{k}))$
$w_{n-k}=w_{-k}$

-
Poiscimo nti koren $z=1$
$z=1(\cos(0)+i\sin(0))=\cos(2\pi)+i\sin(2\pi)$
$r=1;\ \phi=0$
$w_{0}=\cos(0/n)+i\sin(0/n)=1$
$w_{1}=\cos(2\pi/n)+i\sin(2\pi/n)$
$w_{k}=\cos(k*2\pi/n)+i\sin(k*2\pi/n)$
$w_{n-1}=\cos((n-1)*2\pi/n)+i\sin((n-1)2*\pi/n)$
n-ti koreni enote stevila $z=1$ so ogljisca pravilnega n-kotnika vcrtanega v krogu z radijem 1. eno od ogljisc je tocka $(1,0)$

n-ti koren st $z=r(\cos(\phi)+i\sin(\phi))$ so ogljisca pravilnega n-kotnika vcrtanega krogu z radijem $^{n}\sqrt{r}$. Eno od ogl. n-kotnika je tocka $(^{n}\sqrt{r}*\cos(\frac{\phi}{n}), ^{n}\sqrt{r}*\sin(\frac{\phi}{n}))$
Torej nkotnik z ogljiscem (1,0) zasukamo za kot $\frac{\phi}{n}$ v pozitivni smeri

primer:
$z=-1;\ n=4$
$z=1(\cos(\pi)+i\sin(\pi))$
$z_{0}=\cos(\frac{\pi}{4})+i\sin(\frac{\pi}{4})$
$z_{1}=\cos(\frac{3\pi}{4})+i\sin(\frac{3\pi}{4})$
$z_{2}=\cos(\frac{5\pi}{4})+i\sin(\frac{5\pi}{4})$
$z_{3}=\cos(\frac{7\pi}{4})+i\sin(\frac{7\pi}{4})$
